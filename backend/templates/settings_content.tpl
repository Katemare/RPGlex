            ...
            <table cellpadding="0" cellspacing="0" class="listing">
                ...
                {foreach from=$records.records item=record}
                    <tr>
                        ...
                        {/foreach}
                        <td class="actions">
                            <a href="/admin/settings/edit.html?id={$record.id}" title="Edit" class="edit ico">Edit</a>
                            <a href="/admin/settings/delete.html?id={$record.id}" title="Delete" class="delete ico" onclick="showpp(); return false;">Delete</a>
                        </td>
                    </tr>
                {/foreach}
                </form>
